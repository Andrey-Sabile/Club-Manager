...
export interface IClubsClient {
    ...
    uploadAvatar(file: FileParameter | null | undefined): Observable<void>;
    updateClub(id: number, command: UpdateClubCommand): Observable<void>;
}
...
export class ClubsClient implements IClubsClient {
    ...
    uploadAvatar(file: FileParameter | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Clubs/UploadAvatar";
        url_ = url_.replace(/[?&]$/, "");
    ...
    updateClub(id: number, command: UpdateClubCommand): Observable<void> {
        let url_ = this.baseUrl + "/api/Clubs/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateClub(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateClub(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUpdateClub(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class EventsClient implements IEventsClient {
    ...
    createEvents(command: CreateEventCommand): Observable<number> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateEvents(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateEvents(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<number>;
                }
            } else
    ...
    protected processCreateEvents(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getEventById(id: number): Observable<EventDto> {
        let url_ = this.baseUrl + "/api/Events/GetEvent/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetEventById(response: HttpResponseBase): Observable<EventDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class TicketsClient implements ITicketsClient {
    ...
    protected processGetTicketById(response: HttpResponseBase): Observable<TicketDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface ITicketTypesClient {
    getTicketTypesByEventId(eventId: number): Observable<TicketTypeDto[]>;
    createTicketType(command: CreateTicketTypeCommand): Observable<number>;
}

@Injectable({
    providedIn: 'root'
})
export class TicketTypesClient implements ITicketTypesClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getTicketTypesByEventId(eventId: number): Observable<TicketTypeDto[]> {
        let url_ = this.baseUrl + "/api/TicketTypes/{eventId}";
        if (eventId === undefined || eventId === null)
            throw new Error("The parameter 'eventId' must be defined.");
        url_ = url_.replace("{eventId}", encodeURIComponent("" + eventId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTicketTypesByEventId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTicketTypesByEventId(response_ as any);
                } catch (e) {
    ...
    protected processGetTicketTypesByEventId(response: HttpResponseBase): Observable<TicketTypeDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    createTicketType(command: CreateTicketTypeCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/TicketTypes";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateTicketType(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class UpdateClubCommand implements IUpdateClubCommand {
    id?: number;
    name?: string | undefined;
    description?: string | undefined;
    logoUrl?: string | undefined;
    ...
    constructor(data?: IUpdateClubCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateClubCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateClubCommand();
        result.init(data);
        return result;
    }
...
export class CreateTicketTypeCommand implements ICreateTicketTypeCommand {
    ...
    static fromJS(data: any): CreateTicketTypeCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTicketTypeCommand();
        result.init(data);
        return result;
    }
